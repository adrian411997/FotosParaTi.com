...
module.exports.routes = {
  ...
  "GET /admin/desactivar-usuario/:id": "AdminController.desactivarClient",

  "GET /admin/activar-usuario/:id": "AdminController.activarClient",

  "GET /admin/ordenes-cliente/:id": "AdminController.viewOrden",

  "GET /admin/orden-detalle/:id": "AdminController.viewDetail",

  "GET /admin/desactivar-admin/:id": "AdminController.desactivarAdmin",

  "GET /admin/activar-admin/:id": "AdminController.activarAdmin",

  "GET /admin/principal/dashboard": "AdminController.showDashboard",
};
